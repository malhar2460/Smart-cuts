...
export default function Login()
{
    return(
        <div>
            <div className="bg-white px-10 py-16 rounded-3xl">
                <h1 className="text-5xl font-semibold">Welcome Back</h1>
                <p className="mt-5">Welcome back! Please enter your details</p>
                <div className="mt-8">
                    <div className='mt-3'>
                        <label>Email</label>
                        <input type="email"
                    ...
                    <div className="mt-10 flex flex-col">
                        <button className="hover:scale-105  text-semibold border p-2 bg-violet-500 text-white rounded-xl w-full text-lg border-violet-500">Log in</button>
